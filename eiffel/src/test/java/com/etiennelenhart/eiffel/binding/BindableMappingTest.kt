...
class BindableMappingTest {
    ...
    @Test
    fun `GIVEN BindableMapping with 'initialState' WHEN invoked with 'null' THEN 'initialState' is transformed with 'map'`() {
        ...
        val actual = mapping(TestState(), null).emptyStateVisible
