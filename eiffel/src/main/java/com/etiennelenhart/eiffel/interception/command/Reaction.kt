...
import com.etiennelenhart.eiffel.interception.command.Reaction.Consuming
import com.etiennelenhart.eiffel.interception.command.Reaction.Ignoring
import com.etiennelenhart.eiffel.state.Action
import com.etiennelenhart.eiffel.state.State

/**
 * Reaction of a [Command] to a received [Action]. [Consuming] indicates the intent to consume the [Action], [Ignoring] to simply forward it.
 *
