...
/**
 * Convenience inline function to use [ProvidedFactoryViewModel] delegate with type parameter instead of Java class.
 *
 * May be used in a [FragmentActivity] like this:
 * ```
 ...
 * @param[factory] The factory to instantiate the view model.
 */
inline fun <reified T : ViewModel> providedFactoryViewModel(factory: ViewModelProvider.Factory) = ProvidedFactoryViewModel(T::class.java, factory)
